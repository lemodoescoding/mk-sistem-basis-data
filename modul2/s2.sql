...
INSERT INTO books (id, isbn, title, author_name, year_published, synopsis, stock, genre_id, author_id, publisher_id)
  VALUES
('BK001',
'9780123456789',
...
author_name,
'2010',
'Menggali sejarah Indonesia, buku ini menyajikan peristiwa penting dan tokoh berpengaruh yang membentuk peradaban bangsa, membawa pembaca memahami akar budaya dan identitas Indonesia.',
'5',
'GR001',
'AU002',
'PB003'),
...
author_name,
'2005',
'Temukan kekuatan dari kebiasaan kecil yang berdampak besar. Buku ini memberikan strategi praktis untuk membangun kebiasaan positif yang dapat mengubah hidup dan meningkatkan kesejahteraan secara keseluruhan.',
'3',
'GR003',
'AU003',
'PB002'),
...
'Complete Dictionary of Information Technology Terms',
  author_name,
'2020',
'Panduan lengkap untuk istilah-istilah teknologi informasi, buku ini menjelaskan konsep-konsep dasar hingga istilah teknis yang kompleks, menjadikannya sumber referensi yang berguna bagi pelajar dan profesional.',
'7',
'GR005',
'AU001',
'PB001'),
...
'Breaking Barriers: The Inspiring Story of Nelson Mandela',
  author_name,
'2018',
'Kisah luar biasa Nelson Mandela, seorang pejuang kebebasan yang mengatasi rintangan untuk memperjuangkan kesetaraan dan keadilan. Sebuah perjalanan inspiratif tentang keberanian, pengorbanan, dan harapan.',
'2',
'GR004',
'AU005',
'PB001'),
...
'Light at the End of the Road: A Story of Hope',
  author_name,
'2024',
'Dalam perjalanan penuh tantangan, seorang tokoh menemukan kekuatan dari harapan dan persahabatan. Novel ini mengajak pembaca merenungkan arti kehidupan dan pentingnya percaya pada masa depan yang lebih baik.',
'4',
'GR002',
'AU004',
'PB004');

-- TODO: insert author_name to books;
...
ALTER TABLE books_borrows
  DROP CONSTRAINT FK_books_borrows_book_id;
...
ALTER TABLE borrows
  ADD CONSTRAINT PK_borrows PRIMARY KEY (id);

ALTER TABLE books_borrows
  ADD CONSTRAINT FK_books_borrows_book_id FOREIGN KEY (borrow_id) REFERENCES borrows(id)
  ON DELETE CASCADE ON UPDATE CASCADE;
